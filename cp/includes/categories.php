        ...
        <form method="post" action="xhr.php" class="xhr-form">
          ...
          <div id="dialog-panel">
            <div style="padding-top: 2px;">
              ...
              <textarea name="categories" style="width: 400px; height: 200px;" wrap="off" class="d-block block-center"><?php echo htmlspecialchars(file_get_contents(FILE_CATEGORIES)); ?></textarea>

            </div>
          </div>

          <div id="dialog-help">
            <a href="docs/categories.html" target="_blank"><img src="images/help-22x22.png"></a>
          </div>
          ...
          <input type="hidden" name="r" value="_xCategoriesSave"/>
        </form>
