      <div id="dialog-content">
        ...
        <div id="dialog-header">
          ...
          Pages for <?php echo $item['domain']; ?>
        </div>
        ...
        <div id="dialog-panel" dwidth="900px">
          <div>
            ...
            <table class="item-table no-wrap fsize-9pt" border="0" cellspacing="0" cellpadding="4" align="center" style="width: 850px; min-width: 850px;">
              ...
              <tbody>
                <?php
                list($total, $links) = get_trade_pages($item['domain']);
                $counter = 1;
                $color = '#ececec';
                foreach( $links as $page => $amount ):
                ...
                <tr bgcolor="<?php echo $color; ?>">
                  ...
                  <td>
                     <a href="<?php echo htmlspecialchars($page); ?>" target="_blank"><?php echo htmlspecialchars($page); ?></a>
                  </td>
